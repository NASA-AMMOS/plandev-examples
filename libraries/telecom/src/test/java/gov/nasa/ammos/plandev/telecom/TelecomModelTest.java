...
import static gov.nasa.ammos.plandev.contrib.streamline.unit_aware.StandardUnits.MEGABIT_PER_SECOND;
import static gov.nasa.ammos.plandev.contrib.streamline.unit_aware.StandardUnits.METER;
import static gov.nasa.ammos.plandev.contrib.streamline.unit_aware.StandardUnits.WATT;
import static gov.nasa.ammos.plandev.merlin.framework.ModelActions.delay;
import static gov.nasa.ammos.plandev.telecom.TelecomModel.Band.KA_BAND;
import static gov.nasa.ammos.plandev.telecom.TelecomModel.Band.X_BAND;
