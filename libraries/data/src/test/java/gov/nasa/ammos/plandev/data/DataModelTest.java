 ...
 * operations via {@link gov.nasa.ammos.plandev.merlin.framework.ModelActions}.
 *
...
public class DataModelTest {
  ...
  void testPlaybackTransfersToGround() {
    ...
    MutableResource.set(data.volumeRequestedToDownlink,
        gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.Polynomial.polynomial(10_000.0));
    delay(2, SECOND);
  ...
  void testPriorityOrderingDuringPlayback() {
    ...
    MutableResource.set(data.volumeRequestedToDownlink,
        gov.nasa.ammos.plandev.contrib.streamline.modeling.polynomial.Polynomial.polynomial(5_000.0));
    delay(2, SECOND);
