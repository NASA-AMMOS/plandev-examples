...
public class VariableTimeStepGenerator {
  ...
  /**
   ...
   @param t0 - time the third-to-last point was measured
   @param x0 - value when third-to-last point was measured
   @param t1 - time the second-to-last point was measured
   @param x1 - value when second-to-last point was measured
   @param t2 - time the last point was measured
   @param x2 - last point was measured
