...
import static gov.nasa.jpl.aerie.geometry.config.ConfigObject.jsonObjHasKey;
import static gov.nasa.jpl.aerie.geometry.config.RecursiveConfigAccess.getArbitraryJSON;
