...
| 7    | `examples/07-external-events/`            | Scheduling against external events | Procedures for the 03 model |
| 8    | `examples/08-advanced-resources/`         | Streamline resource types | None (standalone) |
| 9    | `examples/09-activity-patterns/`          | Common activity idioms | None (standalone) |
| 10   | `examples/10-testing-patterns/`           | Model testing strategies | None (self-contained model) |
