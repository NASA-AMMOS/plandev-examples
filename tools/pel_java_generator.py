...
DEFAULT_INPUT = "pel.json"


def parse_args(argv=None):
    parser = argparse.ArgumentParser(
        description="Generate PEL (Power Equipment List) Java sources from a pel.json spec.")
    parser.add_argument(
        "--input", "-i", default=DEFAULT_INPUT,
        help=f"Path to the PEL JSON spec (default: {DEFAULT_INPUT})")
    parser.add_argument(
        "--output-dir", "-o", required=True,
        help="Directory to write the generated .java files into. Created if missing.")
    parser.add_argument(
        "--package", "-p", required=True,
        help="Java package for the generated classes, e.g. examples.orbiter.power.pel")
