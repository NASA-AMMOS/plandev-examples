...
public class SimplePEL {
  ...
  public void registerStates(Registrar registrar) {
    ...
    registrar.discrete("/pel/hopState", hopState, new gov.nasa.ammos.plandev.contrib.serialization.mappers.EnumValueMapper<>(HopState.class));
    registrar.discrete("/pel/hopLoad", hopLoad, new gov.nasa.ammos.plandev.contrib.serialization.mappers.DoubleValueMapper());
