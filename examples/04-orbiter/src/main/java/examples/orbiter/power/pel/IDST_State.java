...
/**
* This class was created by the pel_java_generator.py script and represents the state(s) of the IDST as an enum and associates
* a power load amount to each state.
*/
public enum IDST_State {
	OFF(0.0, 0.0),
	ON(16.0, 16.0),
	DOWNLINK(22.0, 22.0);
    private final double cbeload;
    private final double mevload;
    IDST_State(double cbeload, double mevload) {
