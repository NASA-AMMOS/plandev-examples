...
/**
* This class was created by the pel_java_generator.py script and represents the state(s) of the ADCS as an enum and associates
* a power load amount to each state.
*/
public enum ADCS_State {
	OFF(0.0, 0.0),
	ON(79.0, 79.0),
	TURNING(187.0, 187.0);
    private final double cbeload;
    private final double mevload;
    ADCS_State(double cbeload, double mevload) {
