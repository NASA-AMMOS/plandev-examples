...
/**
* This class was created by the pel_java_generator.py script and represents the state(s) of the Prop as an enum and associates
...
public enum Prop_State {
    ...
    Prop_State(double cbeload, double mevload) {
