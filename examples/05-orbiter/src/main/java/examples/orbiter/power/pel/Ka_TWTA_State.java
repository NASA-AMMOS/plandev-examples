...
/**
* This class was created by the pel_java_generator.py script and represents the state(s) of the Ka_TWTA as an enum and associates
* a power load amount to each state.
*/
public enum Ka_TWTA_State {
	OFF(0.0, 0.0),
	ON(135.4, 135.4);
    private final double cbeload;
    private final double mevload;
    Ka_TWTA_State(double cbeload, double mevload) {
