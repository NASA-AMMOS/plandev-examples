...
/**
 * Mission model for the external events example.
 *
 * Composes the power and data libraries with a simple PEL (camera + telecom).
 * Designed to work with procedural scheduling goals that react to external
 * events such as DSN ground station contacts.
 */
