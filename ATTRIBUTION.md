...
|--------------------------------------------------------------------------------------|---|---|
| [`libraries/power/`](libraries/power/)                                               | [`aerie-simple-model-power`](https://github.com/NASA-AMMOS/aerie-simple-model-power) | PEL machinery, battery + solar array models. Package renamed `demosystem` → `gov.nasa.ammos.plandev.power`. PEL generator script moved to [`tools/pel_java_generator.py`](tools/pel_java_generator.py). |
